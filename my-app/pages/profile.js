...
export default function Profile() {
  ...
  return <RouteGuard>
    ...
    {profile && <Card className="page-card p-4">
      ...
      </Row><Button type="submit" variant="success" disabled={isSubmitting}>{isSubmitting ? 'Saving...' : 'Save Goals'}</Button></Form>
    </Card>}
  </RouteGuard>;
}
